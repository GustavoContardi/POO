...
public class Controlador implements Observer {
    ...
    public int nroRondasJ(Jugador j){
        return modelo.getNroManoGanada(j);
    }
    ...
    public String quienCantoTruco(){
        return modelo.getCantoTruco();
    }
    public String quienCantoReTruco(){
        return modelo.getCantoReTruco();
    }
    // ---- OBSERVER ---- \\
    ...
    @Override
    public void actualizarCartaTirada(Jugador j, Carta c) {
        if(this.j.equals(j)) vista.println(j.getNombre() + " tiraste: " + c.toString());
        else vista.println(j.getNombre() + " tiro: " + c.toString());
    }
    ...
    @Override
    public void actualizarFinPartida() {
        vista.limpiarPantalla();
        vista.println("\n--------------------------------------------------------------------");
        vista.println("        FIN DE LA PARTIDA");
        vista.println("MUCHAS GRACIAS POR USAR LA APLICACION");
        vista.println("--------------------------------------------------------------------");
    }
